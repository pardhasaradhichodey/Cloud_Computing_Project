...
const Dashboard = (props) => {
  ...
  useEffect(() => {
    ...
    fetch(
      ...
      .then((userdata) => {setUserData(userdata);console.log(userdata);})
  ...
  return (
    ...
    <Container>
      <Row>
      <Col lg={10}><h1 className="mt-4 mb-4">Dashboard</h1></Col>
      <Col><Button style={{ marginTop: '40px' }} onClick={HandleSignOut}>Log Out</Button></Col>
      </Row>
